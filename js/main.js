...
function moveBackground() {
  ...
  translate = 'translate(' + x*2 + 'px, ' + y*2 + 'px) scale('+ 1.1 +')';

  translate2 = 'translate(' + (-x*2) + 'px, ' + (-y*2) + 'px) scale('+ 1.2 +')';

  translate3 = 'translate(' + x*5 + 'px, ' + y*5 + 'px) scale('+ 1.1 +') rotate(45deg)';

  translate4 = 'translate(' + x*-1 + 'px, ' + y*-1 + 'px) scale('+ 1 +') rotate(45deg)';

  translate5 = 'translate(' + x*10 + 'px, ' + y*10 + 'px) scale('+ 1.1 +') rotate(45deg)';

  translate7 = 'translate(' + x*13 + 'px, ' + y*13 + 'px) scale('+ 1.1 +') rotate(45deg)';

  translate6 = 'translate(' + x*20 + 'px, ' + y*20 + 'px) scale('+ 1.1 +') rotate(45deg)';

  translate8 = 'translate(' + x*0.8 + 'px, ' + y*0.8 + 'px) scale('+ 1.1 +') ';

  translate9 = 'translate(' + x*30 + 'px, ' + y*30 + 'px) scale('+ 1.1 +') ';

  translate10 = 'translate(' + x*1.5 + 'px, ' + y*1.5 + 'px) scale('+ 1.1 +') ';
